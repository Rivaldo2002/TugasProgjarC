...
class Chat:
	def __init__(self):
		...
		self.sessions={}
		self.users = {}
		self.users['ronaldo']={ 'nama': 'Ronaldo Tambunan', 'negara': 'Indonesia', 'password': 'siantar', 'incoming' : {}, 'outgoing': {}}
		self.users['rivaldo']={ 'nama': 'Rivaldo Tambunan', 'negara': 'Indonesia', 'password': 'siantar', 'incoming': {}, 'outgoing': {}}
		self.users['Hotma']={ 'nama': 'Hotma Sinaga', 'negara': 'Indonesia', 'password': 'siantar','incoming': {}, 'outgoing':{}}
